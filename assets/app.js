    ...
    <section class="section">
      ...
      <div class="card" id="sellFormSection" hidden>
        ...
        <div class="form-row">
          ...
          <div class="inline-actions">
            <button class="button secondary" id="openDashboard">Open dashboard</button>
        ...
        <div class="helper">
          Tokens are generated by the site and cannot be custom names. Store your token safely.
        </div>
        <div class="helper">
