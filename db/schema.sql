...
CREATE TABLE listings (
  ...
  currency_mode TEXT NOT NULL DEFAULT 'sek_only',
  payment_methods_json TEXT NOT NULL DEFAULT '[]',
  description TEXT,
  delivery_possible INTEGER NOT NULL DEFAULT 0,
  delivery_price_sek INTEGER,
  contact_mode TEXT NOT NULL,
  public_email TEXT,
  public_phone TEXT,
  public_phone_methods_json TEXT NOT NULL DEFAULT '[]',
...
CREATE TABLE buyer_contacts (
  ...
  buyer_email TEXT,
  buyer_phone TEXT,
  buyer_phone_methods_json TEXT NOT NULL DEFAULT '[]',
